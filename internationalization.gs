...
var __ = function(str,ling){
    ...
    translatables = {
      ...
      "Start":{"en":"Start","it":"Avvia","es":"Inicia","fr":"Lance","de":"Starten"},
      "Instructions":{"en":"Instructions","it":"Istruzioni","es":"Instrucciones","fr":"Instructions","de":"Anleitung"},
      "Settings":{"en":"Settings","it":"Preferenze","es":"Ajustes","fr":"Paramètres","de":"Einstellungen"},
      ...
      "Get bible quotes":{"en":"Get bible quotes","it":"Ricerca citazioni bibliche","es":"Busca citas biblicas","fr":"Obtenir citations bibliques","de":"Erhalten Bibelzitate"},
      ...
      "Left Indent increase":{"en":"Left Indent increase","it":"aumenta Rientro Sinistro","es":"aumentar Sangría Izquierda","fr":"augmenter Retrait gauche","de":"Linker Einzug erhöhen"},
      "Left Indent decrease":{"en":"Left Indent decrease","it":"diminuisci Rientro Sinistro","es":"disminuir Sangría Izquierda","fr":"diminuer Retrait gauche","de":"Linker Einzug verringern"},
      "Right Indent":{"en":"Right Indent","it":"Rientro Destro","es":"Sangría Derecha","fr":"Retrait droit","de":"Richtiger Einzug"},
      "Right Indent increase":{"en":"Right Indent increase","it":"aumenta Rientro Destro","es":"aumentar Sangría Derecha","fr":"augmenter retrait droit","de":"rechten Einzug erhöhen"},
      "Right Indent decrease":{"en":"Right Indent decrease","it":"diminuisci Rientro Destro","es":"disminuir Sangría Derecha","fr":"diminuer retrait droit","de":"rechten Einzug verringern"},
      ...
      "Bible version":{"en":"Bible version","it":"Versione biblica","es":"Versión de la biblia","fr":"Version biblique","de":"Bibelversion"},
      "Visibility":{"en":"Visibility","it":"Visibilità","es":"Visibilidad","fr":"Visibilité","de":"Sichtweite"},
      "Show":{"en":"Show","it":"Mostra","es":"Muestre","fr":"Affiche","de":"Zeigen"},
      "Hide":{"en":"Hide","it":"Nascondi","es":"Oculta","fr":"Cacher","de":"Verstecken"},
      "Wrap":{"en":"Wrap","it":"Avvolgi","es":"Envoltorio","fr":"Enveloppe","de":"Wickeln"},
      "None":{"en":"None","it":"Niente","es":"Ninguno","fr":"Aucun","de":"Keine"},
      "Parentheses":{"en":"Parentheses","it":"Parentesi","es":"Paréntesis","fr":"Parenthèses","de":"Klammern"},
      "Brackets":{"en":"Brackets","it":"Parentesi quadre","es":"Corchetes","fr":"Crochets","de":"eckige Klammern"},
      "Alignment":{"en":"Alignment","it":"Allineamento","es":"Alineación","fr":"Alignement","de":"Ausrichtung"},
      "Left":{"en":"Left","it":"Sinistra","es":"Izquierda","fr":"Gauche","de":"Linksbündig"},
      "Center":{"en":"Center","it":"Centro","es":"Centro","fr":"Centre","de":"Zentriert"},
      "Right":{"en":"Right","it":"Destra","es":"Derecha","fr":"Droit","de":"Rechtsbündig"},
      "Justify":{"en":"Justify","it":"Giustificato","es":"Justificado","fr":"Justifié","de":"Begründeter"},
      "Positioning":{"en":"Positioning","it":"Posizionamento","es":"Posicionamiento","fr":"Positionnement","de":"Positionierung"},
      "Top":{"en":"Top","it":"In alto","es":"Superior","fr":"Haut","de":"Oben"},
      "Bottom":{"en":"Bottom","it":"In basso","es":"Iferior","fr":"Bas","de":"Unten"},
      "Bottom Inline":{"en":"In linea in basso","it":"In linea in basso","es":"Inferior en línea","fr":"Bas en ligne","de":"Unten inline"},
      "Book and Chapter":{"en":"Book and Chapter","it":"Libro e capitolo","es":"Libro y capitulo","fr":"Livre et chapitre","de":"Buch und Kapitel"},
      "Format":{"en":"Format","it":"Formato","es":"Presentación","fr":"Présentation","de":"Aufmachung"},
      "BIBLELANG":{"en":"Language of Bible version","it":"Lingua della versione biblica","es":"Idioma Versión de la biblia","fr":"Langue de la version biblique","de":"Sprache der Bibelversion"},
      "BIBLELANGABBREV":{"en":"Language of Bible version (abbrev)","it":"Lingua della versione biblica (abbrev)","es":"Idioma Versión de la biblia (abrev)","fr":"Langue de la version biblique (abrév)","de":"Sprache der Bibelversion (abkürz)"},
      "USERLANG":{"en":"Language of Docs interface","it":"Lingua di Google Docs","es":"Idioma de Google Docs","fr":"Langue de Google Docs","de":"Sprache von Google Docs"},
      "USERLANGABBREV":{"en":"Language of Docs interface (abbrev)","it":"Lingua di Google Docs (abbrev)","es":"Idioma de Google Docs (abrev)","fr":"Langue de Google Docs (abrév)","de":"Sprache von Google Docs (abkürz)"},
      "Show full reference":{"en":"Show full reference","it":"Mostra riferimento completo","es":"Muestre referencia completa","fr":"Affiche la référence complète","de":"Vollständige Referenz anzeigen"},
      "Verse number":{"en":"Verse number","it":"Numero del Versetto","es":"Número de Versículo","fr":"Numéro du Verset","de":"Vers Nummer"},
      "RESET PREFERENCES TO DEFAULT OPTIONS":{"en":"RESET PREFERENCES TO DEFAULT OPTIONS","it":"RIPRISTINA LE OPZIONI PREDEFINITE","es":"RESTABLECER LAS OPCIONES POR DEFECTO","fr":"Restaurer les paramètres par défaut","de":"Setzen Sie die Standardeinstellungen zurück"},
      "Insert citation":{"en":"Insert citation","it":"Inserisci citazione","es":"Inserta la cita","fr":"Entrez la citation","de":"Fügen Sie das Zitat"},
      "Find verses by keyword":{"en":"Find verses by keyword","it":"Trova versetti per parola chiave","es":"Encontra versículos por palabra clave","fr":"Trouver des versets par mot-clé","de":"Finde Verse nach Stichwort"},
      "":{"en":"","it":"","es":"","fr":"","de":""},
      "":{"en":"","it":"","es":"","fr":"","de":""},
      "":{"en":"","it":"","es":"","fr":"","de":""},
      "DocInterfaceInCM":{"en":"My Docs interface is in centimeters","it":"La mia interfaccia di Google Documenti è in centimetri","es":"Mi interfaz de Google Docs está en centímetros.","fr":"Mon interface Google Docs est en centimètres","de":"Meine Google Text & Tabellen-Oberfläche ist in Zentimetern angegeben"},
